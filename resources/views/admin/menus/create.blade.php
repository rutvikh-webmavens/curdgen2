    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.menus.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sort_order') ? 'is-invalid' : '' }}" type="text" name="sort_order" id="sort_order" value="{{ old('sort_order', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('soft_delete') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="soft_delete" id="soft_delete" value="1" {{ old('soft_delete', 0) == 1 || old('soft_delete') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('create') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="create" id="create" value="1" {{ old('create', 0) == 1 || old('create') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('edit') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="edit" id="edit" value="1" {{ old('edit', 0) == 1 || old('edit') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('show') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="show" id="show" value="1" {{ old('show', 0) == 1 || old('show') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('delete') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="delete" id="delete" value="1" {{ old('delete', 0) == 1 || old('delete') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('column_search') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="column_search" id="column_search" value="1" {{ old('column_search', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('order_by_field_name') ? 'is-invalid' : '' }}" type="text" name="order_by_field_name" id="order_by_field_name" value="{{ old('order_by_field_name', 'id') }}" required>
