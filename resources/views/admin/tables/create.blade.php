    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.tables.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_name') ? 'is-invalid' : '' }}" type="text" name="field_name" id="field_name" value="{{ old('field_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('field_title') ? 'is-invalid' : '' }}" type="text" name="field_title" id="field_title" value="{{ old('field_title', '') }}" required>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('in_list') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="in_list" id="in_list" value="1" {{ old('in_list', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('in_create') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="in_create" id="in_create" value="1" {{ old('in_create', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('in_edit') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="in_edit" id="in_edit" value="1" {{ old('in_edit', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_required') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_required" id="is_required" value="1" {{ old('is_required', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sort_order') ? 'is-invalid' : '' }}" type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', '') }}" step="1">
