                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.menus.update", [$menu->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="model_name" id="model_name" value="{{ old('model_name', $menu->model_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="sort_order" id="sort_order" value="{{ old('sort_order', $menu->sort_order) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="soft_delete" id="soft_delete" value="1" {{ $menu->soft_delete || old('soft_delete', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="create" id="create" value="1" {{ $menu->create || old('create', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="edit" id="edit" value="1" {{ $menu->edit || old('edit', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="show" id="show" value="1" {{ $menu->show || old('show', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="delete" id="delete" value="1" {{ $menu->delete || old('delete', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="column_search" id="column_search" value="1" {{ $menu->column_search || old('column_search', 0) === 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="order_by_field_name" id="order_by_field_name" value="{{ old('order_by_field_name', $menu->order_by_field_name) }}" required>
