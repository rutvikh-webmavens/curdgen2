                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.projects.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="css" id="css" required>
                                ...
                                @foreach(App\Models\Project::CSS_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('css', 'tailwind') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('css'))
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="date_format" id="date_format" required>
                                ...
                                @foreach(App\Models\Project::DATE_FORMAT_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('date_format', 'Y-m-d') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="model_location" id="model_location" required>
                                ...
                                @foreach(App\Models\Project::MODEL_LOCATION_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('model_location', 'app/Models') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="timezone" id="timezone" required>
                                ...
                                @foreach(App\Models\Project::TIMEZONE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('timezone', 'America/Chicago') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
