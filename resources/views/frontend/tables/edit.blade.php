    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.tables.update", [$table->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="field_name" id="field_name" value="{{ old('field_name', $table->field_name) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="field_title" id="field_title" value="{{ old('field_title', $table->field_title) }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="in_list" id="in_list" value="1" {{ $table->in_list || old('in_list', 0) === 1 ? 'checked' : '' }}>
                                <label for="in_list">{{ trans('cruds.table.fields.in_list') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="in_create" id="in_create" value="1" {{ $table->in_create || old('in_create', 0) === 1 ? 'checked' : '' }}>
                                <label for="in_create">{{ trans('cruds.table.fields.in_create') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="in_edit" id="in_edit" value="1" {{ $table->in_edit || old('in_edit', 0) === 1 ? 'checked' : '' }}>
                                <label for="in_edit">{{ trans('cruds.table.fields.in_edit') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_required" id="is_required" value="1" {{ $table->is_required || old('is_required', 0) === 1 ? 'checked' : '' }}>
                                <label for="is_required">{{ trans('cruds.table.fields.is_required') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', $table->sort_order) }}" step="1">
