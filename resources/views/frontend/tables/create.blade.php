    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.tables.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="field_type" id="field_type" required>
                                ...
                                @foreach(App\Models\Table::FIELD_TYPE_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('field_type', 'Text') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="field_title" id="field_title" value="{{ old('field_title', '') }}" required>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="in_list" id="in_list" value="1" {{ old('in_list', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="in_create" id="in_create" value="1" {{ old('in_create', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="in_edit" id="in_edit" value="1" {{ old('in_edit', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="is_required" id="is_required" value="1" {{ old('is_required', 0) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="sort_order" id="sort_order" value="{{ old('sort_order', '') }}" step="1">
